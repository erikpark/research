...
pt <- ggplot(gazella.data, aes(x = Treatment.ID, y = PT, fill = Treatment.ID)) + geom_boxplot() + geom_signif(comparisons = list(c("gg","gs")), test = "wilcox.test", map_signif_level = TRUE, textsize = 10, vjust = +0.7)+
  scale_x_discrete(labels = c("", "")) +
  stat_summary(aes(x=factor(Treatment.ID)), position=position_dodge(0.9), fun.data = fun_length,  geom = "text",
               vjust = c(-0.7,+1.4), size = 5) + labs(x = "", y = "Days unitl pupation") + 
  theme_Publication() + scale_fill_grey(start=1, end = 0.8, name = "Experimental condition", breaks=c("gg","gs"), labels=c("Control", "Heterospecific microbiome"))
...
pw <- ggplot(gazella.data, aes(x = Treatment.ID, y = PW, fill = Treatment.ID)) + geom_boxplot() + geom_signif(comparisons = list(c("gg","gs")), test = "wilcox.test", map_signif_level = TRUE, textsize = 10, vjust = +0.7) +
  scale_x_discrete(labels = c("", "")) +
  stat_summary(aes(x=factor(Treatment.ID)), position=position_dodge(.9), fun.data = fun_length,  geom = "text", vjust = -.4, size = 5) + labs(x = "", y = "Weight (g) at pupa day 3") + theme_Publication() + scale_fill_grey(start=1, end = 0.8, name = "Experimental condition", breaks=c("gg","gs"), labels=c("Control", "Heterospecific microbiome"))
...
ae <- ggplot(gazella.data, aes(x = Treatment.ID, y = AT, fill = Treatment.ID)) + geom_boxplot() + geom_signif(comparisons = list(c("gg","gs")), test = "wilcox.test", map_signif_level = TRUE, , textsize = 10, vjust = +0.7) +
  scale_x_discrete(labels = c("", "")) +
...
ggplot(survivals, aes(x = species, y = survivals, fill = experiment)) + geom_col(position = "dodge", color = "black") + expand_limits(y = 0)+ 
  theme_Publication() + labs(x = "Host Species", y = "Survival Rate") + geom_signif(comparisons = list(c("Sagittarius","Sagittarius")), annotations = pv_final$map_signif, textsize = 8, vjust = 2) + scale_fill_grey(start=1, end = 0.8,  name = "Experimental condition") + geom_text(aes(label = n), position = position_dodge(width = 0.9), vjust = -.5, size = 5)
